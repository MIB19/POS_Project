<div class="card_table" style="margin-left:1%;margin-right:1%;margin-top:1%;">
	<div style="width:100%; text-align: left;padding: 5px;font-size: 13px;">
		<form id="form1" action="simpan_kategory.html" method="post" onsubmit="return check(this.action);" class="form-horizontal form-label-left">  
			...
			<div style="margin-top:10px">
				...
				<br>
				<div class="col-md-12 col-sm-12 col-xs-12">
					<input type="text" name="print" placeholder="Print" value="" required class="form_input">
				</div>
			</div>
			<div style="margin-top:10px">
				<label class="control-label col-md-12 col-sm-12 col-xs-12" for="last-name">Disc Otomatis  <span class="required">*</span></label>
				<br>
				<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div style="margin-top:10px">
				<label class="control-label col-md-12 col-sm-12 col-xs-12" for="last-name">Nominal<span class="required">*</span></label>
				<br>
				<div class="col-md-12 col-sm-12 col-xs-12">
					<input type="text" name="nominal" placeholder="nominal" value="0" required class="form_input">
				</div>
			</div>
