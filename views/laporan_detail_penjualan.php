...
<div class="card_table" style="margin-left:1%;margin-right:1%;margin-top:1%;">
	...
	<form method="POST" action="<?php echo $config->base_url();?>laporan_detail_penjualan_filter.html">
...
<script>
	...
	function print(){
		window.open('<?php echo $config->base_url();?>print_page/1.html','_blank','_blank');
	}
</script>