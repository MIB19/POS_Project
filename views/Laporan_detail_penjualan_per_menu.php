...
<div class="card_table" style="margin-left:1%;margin-right:1%;margin-top:1%;">
	...
	<h2>Laporan Penjualan Per Menu</h2>

	<form method="POST" action="<?php echo $config->base_url();?>laporan_detail_penjualan_per_menu_filter.html">
	...
	<input name="b_print" type="button" class="ipt"   onClick="printdiv('div_print');" value=" Print " hidden>
...
<script>
	...
	function print(){
		window.open('<?php echo $config->base_url();?>print_page/3.html','_blank','_blank');
	}
</script>