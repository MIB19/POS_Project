<div class="card_table" style="margin-left:1%;margin-right:1%;margin-top:1%;">
	<div style="width:100%; text-align: left;padding: 5px;font-size: 13px;">
		<form id="form1" action="update_user_category.html" method="post" onsubmit="return check(this.action);" class="form-horizontal form-label-left">  
			...
			<div style="margin-top:10px">
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<input type="text" name="nama_category" placeholder="nama_category" value="<?php echo $nama_category;?>" required class="form_input">
				</div>
			</div>
			<div style="margin-top:10px">
				...
				<br>
				<div class="col-md-12 col-sm-12 col-xs-12">
					<input type="text" name="discount" placeholder="discount" value="<?php echo $discount;?>" required class="form_input">
				</div>
			</div>
