...
<script>
	...
	<?php if($simpan == '1'){ ?>
		function bayar_sekarang(){
			...
			if(kembalian < 0){
				...
				open('<?php echo $config->base_url();?>print_bill/'+<?php echo $id_trans;?>+'/'+kembalian+'/'+a11+'/'+a12+'.html');
	...
	function simpan(param){
		...
		// window.open('<?php echo $config->base_url();?>print_checker/'+param+'.html','_blank','toolbar=0,scrollbars=1,...,height=350,width=280');
		// setTimeout( function(){ 	
